...
function Text(value)
    game.StarterGui:SetCore("io Hub", {
        Title = "io Hub", 
        Text = tostring(value),
        Icon = "",
        Duration = 10
...
local win = library:Window("io",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("ทั่วไป",[[7040391851]])
local Quest_Tab = win:Tab("    ภารกิจ & สิ่งของ",[[9606626859]])
local PvP_Tab = win:Tab("พีวีพี",[[9606626034]])
local Raid_Tab = win:Tab("ดัน",[[9606629300]])
local Shop_Tab = win:Tab("ร้านค้า",[[9606625251]])
local Island_Tab = win:Tab("วาป",[[9606628205]])
local Setting_Tab = win:Tab("การตั้งค่า",[[9606644121]])
local Status_Tab = win:Tab("สถานะ",[[9613645002]])
local Esp_Tab = win:Tab("ESP",[[9606628205]])
local Hop_Tab = win:Tab("Hop",[[9608089732]])
General_Tab:Label("ออโต้ฟาร์ม")
...
General_Tab:Toggle("ตีเร็ว ","9606294253",_G.Setting_table.FastAttack,function(vu)
...
General_Tab:Dropdown("เร็วจู่โจม","Fast",MIo,function(vu)
...
General_Tab:Label("ฟาร์ม ความชำนาญ")
General_Tab:Toggle("ออโต้ฟาร์มผลไม้ ","9606294253",_G.Setting_table.Farm_Fruit,function(vu)
	Auto_Farm_Fruit = vu
...
General_Tab:Toggle("ออโต้อัพ ปืน","9606294253",_G.Setting_table.Farm_Gun,function(vu)
	Auto_Farm_Gun = vu
...
General_Tab:Toggle("ออโต้อัพ ดาบ","9606294253",_G.Setting_table.Farm_Sword,function(vu)
	Auto_Farm_Sword = vu
...
General_Tab:Label('ฟาร์ม กระดูก')
General_Tab:Toggle("ออโต้ฟาร์มกระดูก","9606294253",_G.Setting_table.Farm_Bone,function(vu)
	Auto_Farm_Bone = vu
...
General_Tab:Label('ออโต้ฟามร์อาคิ')
General_Tab:Toggle("ออโต้ฟาร์ม อาสังเกต ฮาคิ","9606294253",_G.Setting_table.Farm_Ken,function(vu)
	Farm_Ken = vu
...
General_Tab:Toggle("ไฟฉายหยุดทรวงอกอัตโนมัติ","9606294253",_G.Setting_table.Auto_Holy_Torch,function(vu)
	Auto_Holy_Torch = vu
...
Quest_Tab:Toggle("เปิดอัตโนมัติSwan Glass","9610159123",_G.Setting_table.Open_Don_Swan,function(vu)
	Inventory_Fruit = vu
	BringFruit = vu
	Don_Swan_Quest = vu
...
Quest_Tab:Toggle("ออโต้ไปโลกที่สาม","9606294253",false,function(vu)
	Auto_Three_World = vu
end)
spawn(function()
	while wait(.5) do
...
Quest_Tab:Toggle("ดัน ฟีนิกซ์","9606294253",_G.Setting_table.Auto_Phoenix_Awaken,function(vu)
							...
							if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Heal") == 1 then
								...
								if FG >= 6000 then
									...
									if _G.Have_Fruit then
										...
										elseif _G.Setting_table.Phoenix_Hop then
											if not UHIkx then
												Text("รอ2ช.มถึงจะซื้อชิปลงดันต่อได")
												UHIkx = true
											end
											_G.Phoenix_R = true
											Raid_FG()
											...
											if not UHIkz then
												Text("รอ2ช.มถึงจะซื้อชิปลงดันต่อได้")
												UHIkz = true
											end
										end
...
Quest_Tab:Toggle("ออโต้ฮาคิสังเกตV2","9606294253",_G.Setting_table.Farm_Ken_V2,function(vu)
	Farm_Ken = vu
	Farm_Ken_V2 = vu
				...
				if _G.Setting_table.Superhuman and not Superhuman_H then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman") == 1 or game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman") == 2 then
						...
						if game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value <= 300 and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
							_G.Setting_table.Weapon = "อิเล็กโต้"
