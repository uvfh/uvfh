...
<!---
uvfh/uvfh is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('PS Hub BF Premium') then
        makefolder('PS Hub BF Premium')
    end
    if not _G.Dis and not isfile('PS Hub BF Premium/'..Name..'.json') then
        writefile('PS Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('PS Hub BF Premium') and isfile('PS Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('PS Hub BF Premium/'..Name..'.json'))
...
game.StarterGui:SetCore("PS HUB", {
	Title = "PS Hub", 
	Text = "TH",
	Icon = "",
	Duration = 8
...
local win = library:Window("PS",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
