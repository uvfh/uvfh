if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("A Hub | Free script",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RenUi:AddTab("ออโต้ฟาร์ม","")
    local Combat = RenUi:AddTab("Combat","")
    local Stats = RenUi:AddTab("สถิติ","")
    local Teleport = RenUi:AddTab("เทเลพอร์ต","")
    local Dungeon = RenUi:AddTab("ดัน","")
    local DevilFruit = RenUi:AddTab("ผลไม้ปีศาจ","")
    local Shop = RenUi:AddTab("ร้านค้า","")
    local Misc = RenUi:AddTab("อื่น ๆ","")
    --------------------------------------------------------------------
    Main:AddSeperator("การตั้งค่า")
    
    Time = Main:AddLabel("เวลาเซิร์ฟเวอร์")
    ...
    Main:AddToggle("รวม ม็อบ",true,function(value)
    ...
    if World1 then
        Main:AddToggle("ออโต้ทะเลท่ี่2",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        Main:AddToggle("ออโต้ทะเลท่ี่3",_G.AutoThirdSea,function(value)
    ...
    elseif World3 then
        Main:AddToggle("เกาะมิสติกอัตโนมัติ",_G.AutoMysticIsland,function(value)
    ...
    Main:AddSeperator("สไตล์การต่อสู้")
    ...
    Main:AddToggle("ออโต้ซื้อขาไฟ",_G.AutoDeathStep,function(value)
    ...
    Main:AddToggle("ออโต้ซื้อคาราเต้ ",_G.AutoSharkman,function(value)
    ...
    Main:AddToggle("ออโต้ซื้อหมัดไฟฟ้า v2",_G.AutoElectricClaw,function(value)
    ...
    Main:AddToggle("กรงเล็บมังกรอัตโนมัติ",_G.AutoDragonTalon,function(value)
    ...
    Main:AddSeperator("ความชำนาญ")
    
    Main:AddToggle("Auto Farm BF เชี่ยวชาญ",_G.AutoFarmFruitMastery,function(value)
    ...
    Main:AddToggle("ออโต้ฟาร์ม ความชำนาญในการใช้ปืน",_G.AutoFarmGunMastery,function(value)
    ...
    Main:AddButton("รีเฟรชบอส",function()
        BossName:Clear()
            for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
            if string.find(v.Name, "Boss") then
                BossName:Add(v.Name) 
    ...
    Main:AddToggle("บอสฟาร์มอัตโนมัติ",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("ฟาร์มอัตโนมัติบอสทั้งหมด",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("ฟาร์มอัตโนมัติ All Boss Hop",_G.AutoAllBossHop,function(value)
    ...
    Main:AddSeperator("ดันเจี้ยนขั้นสูง")
    ...
    Main:AddSeperator("บัดดี้ดาบ")
    
    Main:AddToggle("ดาบบัดดี้ออโต้",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:AddToggle("ดาบบัดดี้ออโต้ เปลี่ยนเซิฟ",_G.AutoBudySwordHop,function(value)
    ...
    Main:AddToggle("ออโต้อีลีทฮันเตอร์",_G.AutoElitehunter,function(value)
    ...
    Main:AddSeperator("เคียวฮอลโลว์")
    
    Main:AddToggle("เคียวฮอลโลว์อัตโนมัติ",_G.AutoFarmBossHallow,function(value)
    ...
    Main:AddSeperator("หงส์แก้ว")
    
    Main:AddToggle("แว่นออโต้สวอน",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:AddToggle("เซอร์ไพรส์แบบสุ่มอัตโนมัติ",_G.Auto_Random_Bone,function(value)
    ...
    Main:AddToggle("ออโต้ฟาร์ม การสังเกต",_G.AutoObservation,function(value)
    ...
    Main:AddSeperator("เซเบอร์")
    
    Main:AddToggle("ออโต้เซเบอร์",_G.AutoSaber,function(value)
        _G.AutoSaber = value
    ...
    Main:AddSeperator("ดาบในตำนาน")
    
    Main:AddToggle("ดาบในตำนานอัตโนมัติ",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:AddSeperator("สีเสริม")
    
    Main:AddToggle("ปรับแต่งสีอัตโนมัติ",_G.AutoBuyEnchancementColour,function(value)
    ...
    Main:AddToggle("ออโต้ อาคิการสังเกต  v2",_G.AutoObservationv2,function(value)
    ...
    Main:AddToggle("ออโต้โกคุ",_G.AutoRengoku,function(value)
    ...
    Main:AddToggle("ออโต้ยามะ",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    Main:AddToggle("ออโต้ อีโว เผ่า",_G.Auto_EvoRace,function(value)
    ...
    Combat:AddToggle("เอมบอท ปืน",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    Combat:AddToggle("เอมบอท ทักษะ",false,function(value)
    ...
    Combat:AddToggle("เปิดใช้งาน พีวีพี",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    Combat:AddToggle("ปลอดภัย โหมด",false,function(value)
        _G.Safe_Mode = value
    ...
    Combat:AddButton("เกิดใหม่",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
        wait()
    end)
    
    Combat:AddSeperator("ค่าหัว")
    
    local Current = Combat:AddLabel("ค่าหัวในปัจจุบัน  :")
    ...
    local Earn = Combat:AddLabel("ได้รับ")
    ...
    Combat:AddToggle("ค่าหัวฟาร์มอัตโนมัติ",_G.AutoFarmBounty,function(value)
    ...
    Combat:AddSeperator("ค่าหัวเบ็ดเตล็ด")
    
    Combat:AddButton("ผู้เล่นคนต่อไป",function()
        NextplySelect = true
        wait(.1)
        NextplySelect = false
    end)
    
    Combat:AddSlider("ล็อค ",1,25000000,750000,function(value)
        _G.BountyLock = value
    end)
    
    Combat:AddToggle("เริ่มล็อคค่าหัว",false,function(value)
    ...
    Stats:AddSeperator("สถิติอัตโนมัติ")
    
    local Pointstat = Stats:AddLabel("คะแนนสถิติ")
    ...
    Stats:AddToggle("ระยะประชิดอัตโนมัติ",_G.Auto_Melee,function(value)
        _G.Auto_Melee = value
    end)
    
    Stats:AddToggle("ป้องกันอัตโนมัติ",_G.Auto_Defense,function(value)
        _G.Auto_Defense = value
    end)
    
    Stats:AddToggle("ดาบอัตโนมัติ",_G.Auto_Sword,function(value)
        _G.Auto_Sword = value
    end)
    
    Stats:AddToggle("อัตโนมัติ ปืน",_G.Auto_Gun,function(value)
        _G.Auto_Gun = value
    end)
    
    Stats:AddToggle("ผลไม้ปีศาจอัตโนมัติ",_G.Auto_DevilFruit,function(value)
    ...
    Stats:AddSeperator("สถานะ")
    
    local locallv = Stats:AddLabel("ระดับ")
    ...
    local localrace = Stats:AddLabel("แข่ง")
    ...
    local localbeli = Stats:AddLabel("เบลี")
    ...
    local localfrag = Stats:AddLabel("ชิ้นส่วน")
    ...
    local localexp = Stats:AddLabel("ประสบการณ์")
    ...
    Teleport:AddSeperator("เกาะ")
    
    if World1 then
        Teleport:AddDropdown("เลือกเกาะ",{
            "WindMill",
            "Marine",
            "Middle Town",
            "Jungle",
    ...
    Teleport:AddToggle("เทเลพอร์ต",false,function(value)
    ...
    Dungeon:AddToggle("ดันเจี้ยนฟาร์มอัตโนมัติ",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:AddToggle("เครื่องปลุกอัตโนมัติ",_G.Auto_Awakener,function(value)
    ...
    Dungeon:AddDropdown("เลือกชิป",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},function(value)
        _G.SelectChip = value
    end)
    
    Dungeon:AddToggle("เลือกดันเจี้ยนอัตโนมัติ",_G.AutoSelectDungeon,function(value)
    ...
    Dungeon:AddToggle("ชิปซื้ออัตโนมัติ",_G.AutoBuyChip,function(value)
    ...
    Dungeon:AddButton("ซื้อชิปเลือก",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dungeon:AddToggle("เริ่มอัตโนมัติ ดัน",_G.Auto_StartRaid,function(value)
    ...
    Dungeon:AddButton("เริ่ม ดัน",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Dungeon:AddButton("เกาะต่อไป",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    ...
    if World2 then
        Dungeon:AddButton("เทเลพอร์ตไปที่แล็บ",function()
    ...
    if World2 then
        Dungeon:AddButton("ห้องปลุก",function()
    ...
    Misc:AddToggle("ESP ผลไม้",false,function(value)
        DevilFruitESP = value
    ...
    Misc:AddSeperator("ความสามารถ")
    
    Misc:AddToggle("Dodge ไม่มีคูลดาวน์",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Misc:AddToggle("พลังงานที่ไม่มีที่สิ้นสุด",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Misc:AddToggle("การแข่งขันที่ใช้งานอัตโนมัติ",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("ความสามารถที่ไม่มีที่สิ้นสุด",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:AddToggle("ช่วงการสังเกตที่ไม่มีที่สิ้นสุด",getgenv().InfiniteObRange,function(value)
