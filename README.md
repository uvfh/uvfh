if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("ไก่ตัน",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    Main:AddToggle("ตั้งจุดเกิดอัตโนมัติ",true,function(value)
    ...
    Main:AddToggle("นำม็อบ",true,function(value)
    ...
    local AutoFarm = Main:AddToggle("ออโต้ฟาร์ม เลเวล",_G.AutoFarm,function(value)
        _G.AutoFarm = value
    ...
    if World1 then
        Main:AddToggle("ออโต้โลกที่2",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        Main:AddToggle("ออโต้โลกทึ่3",_G.AutoThirdSea,function(value)
    ...
    Main:AddToggle("ตีไว",,function(value)
            (getgenv()).Config = {
 ["FastAttack"] = true,
 ["ClickAttack"] = false
} 
...
spawn(function()
    ...
    Main:AddToggle("การสังเกตฟาร์มอัตโนมัติ Hop",_G.AutoObservation_Hop,function(value)
