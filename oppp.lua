...
function CheckQuest() 
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("TH Hub Mobile",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RenUi:AddTab("ฟาร์มหลัก","")
    local Stats = RenUi:AddTab("สถิติ","")
    local Combat = RenUi:AddTab("พีวีพี","")
    local Teleport = RenUi:AddTab("เทเลพอร์ต","")
    local Dungeon = RenUi:AddTab("ดันเจี้ยน","")
    local Shop = RenUi:AddTab("ร้านค้า","")
    local DevilFruit = RenUi:AddTab("ผลไม้ปีศาจ","")
    local Misc = RenUi:AddTab("อื่น ๆ","")
    --------------------------------------------------------------------
    Main:AddSeperator("หลัก1")
    ...
    local AutoFarm = Main:AddToggle("ออโต้ฟาร์มเลเวล",_G.Settings.Auto_Farm_Level,function(value)
    ...
    Main:AddToggle("รวมม็อบ",true,function(value)
        _G.BringMonster = value
    end)
   Main:AddToggle("ตีไว",true,function(value)
    (getgenv()).Config = {
 ["FastAttack"] = true,
 ["ClickAttack"] = false
} 
...
spawn(function()
    ...
    local locallv = Stats:AddLabel("เลเวล")
    ...
    local localrace = Stats:AddLabel("เผ่า")
    ...
    local localstat = Stats:AddLabel("คะแนนสถิติ")
    ...
    local localbountyhornor = Stats:AddLabel("ค่าหัว")
    ...
    local localDevil = Stats:AddLabel("ผลไม้ปีศาจ")
    ...
    Dungeon:AddToggle("ดันเจี้ยนอัตโนมัติ",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:AddToggle("ผลอัตโนมัติตื่น",_G.Auto_Awakener,function(value)
    ...
    Dungeon:AddToggle("ซื้อชิปอัตโนมัติ",_G.AutoBuyChip,function(value)
    ...
    Dungeon:AddToggle("เริ่ม ดันเจี้ยบ",_G.Auto_StartRaid,function(value)
