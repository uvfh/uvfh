...
local AutoFarm = Library:Tab("ออโต้ฟาร์ม")
local Stats = Library:Tab("สถิติ")
Wapon = {}
...
AutoFarm:Button("รีเฟรชอาวุธ",function()
	SelectWeapon:Clear()
	for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
		if v:IsA("Tool") then
...
AutoFarm:Toggle("ออโต้ฟาร์มเลเวล",false,function(vu)
    _G.AutoFarm = vu
...
AutoFarm:Toggle("รวมม็อบ",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
AutoFarm:Toggle("ตีเร็ว",true,function(Fast)
    _G.FastAttack = Fast
end)
...
AutoFarm:Toggle("ออโต้เปิดอาคิ",true,function(d)
_G.AUTOHAKI = d
end)
spawn(function()
    while wait(.1) do
...
Stats:Toggle("ป้องกัน",false,function(value)
defense = value
end)
...
Stats:Toggle("ผลไม้ปีศาจ",false,function(value)
demonfruit = value
end)
...
PointStats = 1
Stats:Slider("จุด",1,100,PointStats,nil,function(value)
PointStats = value
end)
